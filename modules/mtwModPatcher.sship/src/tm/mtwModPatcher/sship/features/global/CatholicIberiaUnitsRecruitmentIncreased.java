...
//		;recruit_pool    "Light Men at Arms"  0   0.085   1  0  requires factions { england, france, aragon, } and not event_counter first_watch 1 and not hidden_resource england and not hidden_resource france and not hidden_resource aragon
		...
		edb.addCapabilities("castle_barracks", "drill_square", CastleType,
				"recruit_pool    \"Light Swordsmen\"  1   0.13   1  0  requires factions { hre, spain, hungary, teutonic_order, portugal, } and not event_counter first_watch 1 and hidden_resource poland or hidden_resource hre or hidden_resource spain or hidden_resource pisa or hidden_resource venice or hidden_resource papal_states or hidden_resource hungary or hidden_resource portugal");
		edb.addCapabilities("castle_barracks", "drill_square", CastleType,
				"recruit_pool    \"Light Swordsmen\"  0   0.085   1  0  requires factions { hre, spain, hungary, teutonic_order, portugal, } and not event_counter first_watch 1 and not hidden_resource poland and not hidden_resource hre and not hidden_resource spain and not hidden_resource pisa and not hidden_resource venice and not hidden_resource papal_states and not hidden_resource hungary and not hidden_resource portugal");
		edb.addCapabilities("castle_barracks", "drill_square", CastleType,
	...
	protected void addSergentSpearmen() throws PatcherLibBaseEx {
		...
		edb.addRecuitment( "castle_barracks", "garrison_quarters", CastleType, sergSpear,
				1, UnitReplenishRate.R13, 1, 0, factionsRequirement); //and " + orderHousesRequirement

		edb.addRecuitment("castle_barracks", "drill_square", CastleType, sergSpear,
				1, UnitReplenishRate.R9, 2, 0, factionsRequirement); //and " + orderHousesRequirement

		// #####  C I T Y  Order Houses #####
//		exportDescrBuilding.addRecuitment("templars_chapter_house", "templars_minor_ch", "city", sergSpear,
//				1, UnitReplenishRate.R13, 1, 0, factionsRequirement + " and " + orderHousesRequirement);
//		exportDescrBuilding.addRecuitment("templars_chapter_house", "templars_major_ch", "city", sergSpear,
//				1, UnitReplenishRate.R10, 2, 0, factionsRequirement + " and " + orderHousesRequirement);
//
//		exportDescrBuilding.addRecuitment("st_johns_chapter_house", "st_johns_minor_ch", "city", sergSpear,
//				1, UnitReplenishRate.R13, 1, 0, factionsRequirement + " and " + orderHousesRequirement);
//		exportDescrBuilding.addRecuitment("st_johns_chapter_house", "st_johns_major_ch", "city", sergSpear,
//				1, UnitReplenishRate.R10, 2, 0, factionsRequirement + " and " + orderHousesRequirement);
//
//
//		// # Santiago - one for City & Castle
//		exportDescrBuilding.addRecuitment("knights_of_santiago_chapter_house", "knights_of_santiago_minor_ch", null, sergSpear,
//				1, UnitReplenishRate.R10, 1, 0, factionsRequirement + " and " + orderHousesRequirement);
//		exportDescrBuilding.addRecuitment("knights_of_santiago_chapter_house", "knights_of_santiago_major_ch", null, sergSpear,
//				1, UnitReplenishRate.R8, 2, 0, factionsRequirement + " and " + orderHousesRequirement);
//
//
//		// #####  C A S T L E   Order Houses #####
//		exportDescrBuilding.addRecuitment("templars_chapter_house_castle", "templars_minor_ch", CastleType, sergSpear,
//				1, UnitReplenishRate.R10, 1, 0, factionsRequirement + " and " + orderHousesRequirement);
//		exportDescrBuilding.addRecuitment("templars_chapter_house_castle", "templars_major_ch", CastleType, sergSpear,
//				1, UnitReplenishRate.R8, 2, 0, factionsRequirement + " and " + orderHousesRequirement);
//
//		exportDescrBuilding.addRecuitment("st_johns_chapter_house_castle", "st_johns_minor_ch", CastleType, sergSpear,
//				1, UnitReplenishRate.R10, 1, 0, factionsRequirement + " and " + orderHousesRequirement);
//		exportDescrBuilding.addRecuitment("st_johns_chapter_house_castle", "st_johns_major_ch", CastleType, sergSpear,
//				1, UnitReplenishRate.R8, 2, 0, factionsRequirement + " and " + orderHousesRequirement);


//		// ## Castle Barracks #2 : org : R6 , R8 , R12 , MAX : 1
//		exportDescrBuilding.addRecuitment("castle_barracks", "garrison_quarters", CastleType, sergSpear,
...
//		exportDescrBuilding.addRecuitment("castle_barracks", "drill_square", CastleType, sergSpear,
...
//		exportDescrBuilding.addRecuitment("castle_barracks", "barracks", CastleType, sergSpear,
...
//		exportDescrBuilding.addRecuitment("castle_barracks", "armoury", CastleType, sergSpear,
...
//		orderHousesRequirement += "building_present_min_level knights_of_santiago_chapter_house knights_of_santiago_minor_ch";
	...
	protected void addArmoredSpearmen() throws PatcherLibBaseEx {
		...
		// # Santiago - one for City & Castle
		edb.addRecuitment("knights_of_santiago_chapter_house", "knights_of_santiago_minor_ch", null, sergSpearSymbol,
				1, UnitReplenishRate.R15, 1, 0, factionsRequirement + " and " + orderHousesRequirement);
		edb.addRecuitment("knights_of_santiago_chapter_house", "knights_of_santiago_major_ch", null, sergSpearSymbol,
				1, UnitReplenishRate.R13, 2, 0, factionsRequirement + " and " + orderHousesRequirement);


		// #####  C A S T L E   Order Houses #####
		edb.addRecuitment("templars_chapter_house_castle", "templars_minor_ch", CastleType, sergSpearSymbol,
				1, UnitReplenishRate.R12, 1, 0, factionsRequirement + " and " + orderHousesRequirement);
		edb.addRecuitment("templars_chapter_house_castle", "templars_major_ch", CastleType, sergSpearSymbol,
				1, UnitReplenishRate.R10, 2, 0, factionsRequirement + " and " + orderHousesRequirement);

		edb.addRecuitment("st_johns_chapter_house_castle", "st_johns_minor_ch", CastleType, sergSpearSymbol,
				1, UnitReplenishRate.R12, 1, 0, factionsRequirement + " and " + orderHousesRequirement);
		edb.addRecuitment("st_johns_chapter_house_castle", "st_johns_major_ch", CastleType, sergSpearSymbol,
				1, UnitReplenishRate.R10, 2, 0, factionsRequirement + " and " + orderHousesRequirement);
	}
	...
	protected void addCaballerosVillanosToAragon() throws PatcherLibBaseEx {
		...
		edb.addRecuitment("equestrian" , "stables" , CastleType , caballerosVillanos , 0, UnitReplenishRate.R10, 1, 0, reqs);
		edb.addRecuitment("equestrian" , "knights_stables" , CastleType , caballerosVillanos , 0, UnitReplenishRate.R9, 1, 0, reqs);
		edb.addRecuitment("equestrian" , "barons_stables" , CastleType , caballerosVillanos , 0, UnitReplenishRate.R8, 1, 0, reqs);
		edb.addRecuitment("equestrian" , "earls_stables" , CastleType , caballerosVillanos , 0, UnitReplenishRate.R7, 1, 0, reqs);
		edb.addRecuitment("equestrian" , "kings_stables" , CastleType , caballerosVillanos , 0, UnitReplenishRate.R6, 1, 0, reqs);
	}
	...
	protected void addUrbanMilitia() throws PatcherLibBaseEx {
		...
		edb.addCapabilities("barracks", "city_watch", "city",	// old : town_watch
				"\t\t\trecruit_pool  \"Urban Spear Militia\"  1   0.13   2  0  requires factions { spain, aragon, portugal, } ; Patcher Added");

		edb.addCapabilities("barracks", "militia_drill_square", "city",	// old : town_guard
				"\t\t\trecruit_pool  \"Urban Spear Militia\"  1   0.17   3  0  requires factions { spain, aragon, portugal, } ; Patcher Added");

		// ## Castle ## levels mustering_hall garrison_quarters drill_square barracks armoury

//		exportDescrBuilding.addCapabilities("castle_barracks", "garrison_quarters", CastleType,
//				"\t\t\trecruit_pool  \"Urban Spear Militia\"  1   0.13   1  1  requires factions { spain, aragon, portugal, } ; Patcher Added");

		edb.addCapabilities("castle_barracks", "drill_square", CastleType,
				"\t\t\trecruit_pool  \"Urban Spear Militia\"  1   0.13   1  1  requires factions { spain, aragon, portugal, } ; Patcher Added");

		edb.addCapabilities("castle_barracks", "barracks", CastleType,
				"\t\t\trecruit_pool  \"Urban Spear Militia\"  1   0.13   1  1  requires factions { spain, aragon, portugal, } ; Patcher Added");

		edb.addCapabilities("castle_barracks", "armoury", CastleType,
				"\t\t\trecruit_pool  \"Urban Spear Militia\"  1   0.13   1  1  requires factions { spain, aragon, portugal, } ; Patcher Added");
	}
