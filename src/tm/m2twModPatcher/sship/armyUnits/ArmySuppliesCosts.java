...
import tm.m2twModPatcher.lib.common.scripting.campaignScript.conditions.character.*;
import tm.m2twModPatcher.lib.common.scripting.campaignScript.conditions.various.CompareCounter;
import tm.m2twModPatcher.lib.common.scripting.campaignScript.conditions.various.TraitName;
import tm.m2twModPatcher.lib.common.scripting.campaignScript.core.*;
...
import tm.m2twModPatcher.lib.common.scripting.campaignScript.keywords.*;
...
import tm.m2twModPatcher.lib.fileEntities.data.world.maps.campaign.*;
...
public class ArmySuppliesCosts extends Feature {
	...
	@Getter @Setter
	private int fullStackFullCost = 3000;
	@Getter @Setter
	private double aiMultiplier = 0.75;
	@Getter @Setter
	private boolean loggingEnabled = true;
	@Getter @Setter
	private boolean cumansExcluded = true;
	@Getter @Setter
	private boolean siegeCostDisabled = true;
	...
	public void makeUpdatesBasedOnTraitsArmySize() throws PatcherLibBaseEx {
		...
		_CampaignScript.insertAtEndOfFile(resultLines);
	}
	...
	private MonitorEventBlock createArmySizeMonitor(int armySize, double cost, List<Condition> conditions, String commentSuffix) {
		...
		List<FactionAiEcId> factions = _CampaignScript.FactionsAiEcIds;
	...
	private void addArmySizeTraitsDescriptions(int fullStackCost) throws PatcherLibBaseEx {
		LinesProcessor lines = _ExportVnvs.getLines();
